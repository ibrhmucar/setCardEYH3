...
public class BrowserUtils {
    ...
    public static void clickGeneralButton(String buttonName) {

        String path = "//button[contains(text(),'" + buttonName + "')]";
        WebElement button = com.setcard.utilities.Driver.get().findElement(By.xpath(path));
        BrowserUtils.waitForVisibility(button,7);
        button.click();
        ...
        public static void switchToWindow (String targetTitle){
            String origin = com.setcard.utilities.Driver.get().getWindowHandle();
            for (String handle : com.setcard.utilities.Driver.get().getWindowHandles()) {
